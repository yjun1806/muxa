...
struct AgentActivityEstimatorTests {
    ...
    @Test func testExplicitWaitingPinsAndIgnoresHeartbeat() {
    ...
    @Test func testExplicitWorkingPinsAndIgnoresTick() {
        let waiting = AgentActivityEstimator().applying(.explicit(.waiting), now: 100)
    ...
    @Test func testHooksOverrideWorkingPin() {
    ...
    @Test func testExplicitIdlePinsAndIgnoresHeartbeat() {
    ...
    @Test func testCommandFinishedGoesDoneAndUnpins() {
    ...
    @Test func testProcessExitedPinsDone() {
    ...
    @Test func testBorderColorForAllButIdle() {
