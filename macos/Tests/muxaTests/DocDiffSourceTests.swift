...
struct DocDiffSourceTests {
    ...
    @Test func testModifiedFileReadsHeadAndWorktree() {
    ...
    @Test func testUntrackedHasEmptyOldSide() {
    ...
    @Test func testDeletedHasEmptyNewSide() {
    ...
    @Test func testRenameReadsOldPathFromHead() {
    ...
    @Test func testCommitFileReadsBothRevisions() {
    ...
    @Test func testCommitFileRenameUsesOldPathForParent() {
    ...
    @Test func testAggregateTargetsHaveNoSource() {
...
struct ChangesViewModeTests {
    ...
    @Test func testUnifiedAndSideBySideAlwaysAvailable() {
    ...
    @Test func testDocumentOnlyForMarkdown() {
    ...
    @Test func testAggregateHasNoDocumentMode() {
    ...
    @Test func testCommitFileMarkdownSupportsDocument() {
    ...
    @Test func testMarkdownExtensionsMatchFileViewer() {
