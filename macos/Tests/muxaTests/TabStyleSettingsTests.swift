...
struct TabStyleSettingsTests {
    ...
    @Test func cardIsFilledCardWithBottomRule() {
    ...
    @Test func underlineHasNoFillBottomRule() {
    ...
    @Test func pillIsFloatingCapsuleNoIndicator() {
    ...
    @Test func pillFillRadiusClampedTo4Through9() {
    ...
    @Test func blockIsSquareFilledNoLine() {
        let k = knobs(.block)
        #expect(k.filled)
    ...
    @Test func minimalHasOnlyWeightSignal() {
        let k = knobs(.minimal)
        #expect(!k.filled)                      // 면 없음
    ...
    @Test func everyStyleMapsWithoutTrap() {
    ...
    @Test func defaultsMatchCurrentLook() {
