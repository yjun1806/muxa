...
struct ReviewCommentAnchorTests {
    ...
    @Test func testFilePathFromDiffHeader() {
    ...
    @Test func testResolveAnchoredWhenUnchanged() {
    ...
    @Test func testResolveMovedWhenLineShifted() {
    ...
    @Test func testResolveOutdatedWhenTextGone() {
    ...
    @Test func testResolveOutdatedWhenAmbiguous() {
