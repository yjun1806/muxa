...
struct AgentRowTests {
    ...
    @Test func sectionsSplitTerminalsFromViewers() {
    ...
    @Test func sectionsFoldIdleTerminalsOnly() {
    ...
    @Test func sectionsOfEmptyDrawsNothing() {
    ...
    @Test func waitingSplitsBodyAndTime() {
    ...
    @Test func timeLabelOnlyForWaiting() {
    ...
    @Test func bodyLabelMatchesSubtitleSansTime() {
    ...
    @Test func compactNegativeClampsToZero() {
