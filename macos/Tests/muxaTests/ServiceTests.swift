...
struct ServiceTests {
    ...
    @Test func sessionNameRoundTrip() {
    ...
    @Test func groupByWorkspacePutsCurrentFirst() {
    ...
    @Test func sessionNameRoundTripWithUUID() {
    ...
    @Test func foreignSessionIsRejected() {
    ...
    @Test func parsePanesRunningAndDead() {
    ...
    @Test func parsePanesNormalExitIsZero() {
    ...
    @Test func locatedServiceCwdResolutionChain() {
    ...
    @Test func runCwdOverrideInheritsWhenSameAsDefault() {
    ...
    @Test func runCwdOverrideStoresDifferentPath() {
    ...
    @Test func runCwdOverrideExpandsTilde() {
    ...
    @Test func runCwdOverrideResolvesRelativeAgainstDefault() {
    ...
    @Test func orphanIsUnregisteredServiceOfAKnownProject() {
    ...
    @Test func unknownProjectSessionIsNeverOrphan() {
    ...
    @Test func noKnownProjectsDeletesNothing() {
    ...
    @Test func knownProjectWithNoServicesYieldsOrphans() {
        let orphans = ServiceSession.orphans(sessions: ["muxa__P__a", "muxa__P__b"],
                                             liveServiceIds: [], knownProjectIds: ["P"])
    ...
    @Test func extractPortFromViteOutput() {
        let log = """
        [vite] starting...
    ...
    @Test func extractPortFromBindAddresses() {
    ...
    @Test func extractPortUsesLastMatch() {
        let log = """
        http://localhost:3000/
    ...
    @Test func extractPortNoneWhenAbsent() {
    ...
    @Test func attachCommandQuotesTarget() {
    ...
    @Test func injectionIdYieldsNoSessionName() {
    ...
    @Test func underscorePairIdYieldsNoSessionName() {
    ...
    @Test func parsePanesUsesLowestPane() {
        let raw = """
        muxa__P__web|0|1|1
        muxa__P__web|1|0|
        """
    ...
    @Test func parsePanesHandlesNonZeroBaseIndex() {
    ...
    @Test func liveServiceIdsSpanAllWorkspacesAndProjects() {
    ...
    @Test func liveServiceIdsEmptyWhenNoServices() {
    ...
    @Test func collectAllServicesCarriesLocation() {
    ...
    @Test func collectAllServicesEmpty() {
        let p = Project(id: "P", name: "a", path: nil)
        let ws = Workspace(id: "W", path: nil, name: "w", projects: [p], activeProjectId: "P")
    ...
    @Test func tidyCollapsesBlankRunsBetweenLogAndCause() {
        let raw = """
    ...
    @Test func tidyStripsTrailingSpacesOnEachLine() {
    ...
    @Test func projectServicesRoundTrip() throws {
    ...
    @Test func oldProjectJSONWithoutServicesDecodes() throws {
