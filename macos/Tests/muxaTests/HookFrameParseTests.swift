...
struct HookFrameParseTests {
    @Test func parsesHeaderAndPayload() {
    ...
    @Test func payloadWithNewlinesSurvives() {
        let frame = "hook\tTAB-1\tStop\n{\n  \"is_interrupt\": true\n}"
    ...
    @Test func payloadWithTabsSurvives() {
    ...
    @Test func emptyOrBrokenPayloadStillYieldsEvent() {
    ...
    @Test func malformedHeaderIsRejected() {
    ...
    @Test func legacyLineIsNotAHookFrame() {
    ...
    @Test func lineProtocolFieldOrder() {
    ...
    @Test func lineProtocolResumeTrustFollowsCommandShape() {
    ...
    @Test func lineProtocolResumeOnlyAndDiscard() {
