...
struct AgentPromptTests {
    ...
    @Test func testParseKeepsPlainText() {
    ...
    @Test func testParseNilAndBlankReturnNil() {
    ...
    @Test func testParseCountsAndStripsImageMarkers() {
    ...
    @Test func testParseImageOnlyPromptSurvives() {
    ...
    @Test func testParseClampsLongText() {
    ...
    @Test func testOneLineFlattensNewlines() {
    ...
    @Test func testUserPromptSubmitCarriesPrompt() {
    ...
    @Test func testUserPromptSubmitWithoutPromptFieldIsNil() {
        #expect(interpret("{}").prompt == nil)
    }

    /// 다른 이벤트(Stop 등)는 prompt를 건드리지 않는다 — "변화 없음"과 "지우기"가 안 섞이게.
    @Test func testStopDoesNotCarryPrompt() {
